...
{
    // adjusting Image class to canvas class coordinates and dimensions
    internal class CanvasCollageImage : Image
    {
        ...
        //constructor
        public CanvasCollageImage(string filepath) : base()
        {
        ...
        public static void swap_affinity(CanvasCollageImage prey, CanvasCollageImage hunter)
        {
